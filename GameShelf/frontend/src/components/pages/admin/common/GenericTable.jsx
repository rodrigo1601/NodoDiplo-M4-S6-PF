        ...
        <>
            <div className="overflow-x-auto rounded-xl border border-white/6">
                <table className="w-full text-left">
                    ...
                    <tbody>
                        {data.map((item, index) => (
                            <tr key={item._id || index} className="border-t border-white/4 hover:bg-white/2 transition-colors">
                                ...
                                <td className="px-4 py-3">
                                    <span className={`text-[11px] font-bold px-2 py-0.5 rounded-md
                                        ${item.isActive ? "text-green-400 bg-green-400/10" : "text-gray-500 bg-white/4"}`}>
                                ...
                                <td className="px-4 py-3">
                                    <div className="flex items-center gap-2">
                                        <button
                                            ...
                                            className="text-[11px] px-2.5 py-1 rounded-md border border-white/7 text-gray-500 hover:border-cyan-500/40 hover:text-cyan-400 hover:bg-cyan-500/10 transition-all cursor-pointer"
                                        >
                                            Editar
                                        </button>
                                        <button
